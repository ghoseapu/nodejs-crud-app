...
//submitting data routes
  ...
  //passing object of form data directly to collection
  const user = new User(req.body);
  //aving this to database and this return promise
  user.save() 
    .then(result => {
      res.redirect('/users');//if success save this will redirect to home page
    })
...
//404 errors routes
//this will auto run in case there are no routes
